...
if ( is_home() ) : ?>
	<header id="header" class="header" role="banner">
		<div class="site-title">
			...
			<a class="site-title__titulo" href="<?php echo site_url('/perfil'); ?>"><h3>Nosso Perfil</h3></a>
			<div></div>
			<h1 class="site-title__imagem">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
					<img src="<?php echo get_theme_file_uri('/assets/images/logo-white.png'); ?>" title="Voltar para a Página Inicial" alt="Marcos Inácio Advocacia">
				</a>
			</h1>
		</div> <!-- site title -->
	</header>
...
<?php else : ?>
	<header id="header" role="banner" class="header--black  header--page">
		<div class="site-title container">
			<h1 class="site-title__imagem site-title__imagem--page">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
					<img src="<?php echo get_theme_file_uri('/assets/images/logo-horizontal-white.png'); ?>" title="Voltar para a Página Inicial" alt="Marcos Inácio Advocacia">
				</a>
			</h1>
			<div></div>
		</div> <!-- site-title -->
