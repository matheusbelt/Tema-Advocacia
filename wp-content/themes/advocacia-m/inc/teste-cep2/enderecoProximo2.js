...
$(document).ready(function() {
 ...
 //Objeto de objetos que contem cada filial e suas informacoes. Precisa ser criado um novo objeto para cada filial a ser acrescentada
  ...
  var filiais = {
    ...
    endereco: resgatarEndereco(56506640) + ", Número XXX", //Insira o endereço manualmente, entre aspas, ou gere automaticamente com a funcao resgatarEndereco() usando o CEP como entrada e concatene o número do prédio da filial.
    ...
    cep:58100263,
    telefone:"(83)3333-22222",
    endereco: resgatarEndereco(58100263) + ", Número XXX",
    ...
    endereco: resgatarEndereco(59300000) + ", Número XXX",
    ...
    endereco: resgatarEndereco(58900000) + ", Número XXX",
    ...
    endereco: resgatarEndereco(58410045) + ", Número XXX",
    ...
    cep:44790000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(44790000) + ", Número XXX",
    ...
    cep:59190000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(59190000) + ", Número XXX",
    ...
    cep:55010540,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(55010540) + ", Número XXX",
    ...
    cep:63700000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(63700000) + ", Número XXX",
    ...
    cep:59380000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(59380000) + ", Número XXX",
    ...
    cep:60115190,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(60115190) + ", Número XXX",
    ...
    cep:55295080,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(55295080) + ", Número XXX",
    ...
    cep:55900000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(55900000) + ", Número XXX",
    ...
    cep:58200000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(58200000) + ", Número XXX",
    ...
    cep:54080310,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(54080310) + ", Número XXX",
    ...
    cep:59550000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(59550000) + ", Número XXX",
    ...
    cep:58052570,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(58052570) + ", Número XXX",
    ...
    cep:63010212,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(63010212) + ", Número XXX",
    ...
    cep:62930000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(62930000) + ", Número XXX",
    ...
    cep:58280000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(58280000) + ", Número XXX",
    ...
    cep:58500000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(58500000) + ", Número XXX",
    ...
    cep:59600195,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(59600195) + ", Número XXX",
    ...
    cep:59064180,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(59064180) + ", Número XXX",
    ...
    cep:56200000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(56200000) + ", Número XXX" + ", Número XXX",
    ...
    cep:55540000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(55540000) + ", Número XXX",
    ...
    cep:59146210,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(59146210) + ", Número XXX",
    ...
    cep:58700590,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(58700590) + ", Número XXX",
    ...
    cep:59900000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(59900000) + ", Número XXX",
    ...
    cep:56304060,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(56304060) + ", Número XXX",
    ...
    cep:58755000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(58755000) + ", Número XXX",
    ...
    cep:50020140,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(50020140) + ", Número XXX",
    ...
    cep:58297000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(58297000) + ", Número XXX",
    ...
    cep:58300380,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(58300380) + ", Número XXX",
    ...
    cep:58340000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(58340000) + ", Número XXX",
    ...
    cep:62010560,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(62010560) + ", Número XXX",
    ...
    cep:58225000,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(58225000) + ", Número XXX",
    ...
    cep:56903480,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(56903480) + ", Número XXX",
    ...
    cep:65075260,
    telefone:"(83)tel da filial 05",
    endereco: resgatarEndereco(65075260) + ", Número XXX",
