			...
			<div class="container">
				...
				<article class="col-md-4 informacoes__single">
					<div class="col-xs-12 svg-peaple">
						<center>
							<div class="svg-align"><img height="50" src="<?php echo get_theme_file_uri('/assets/images/park.png'); ?>" alt=""></div>
						</center>
					</div>
					<div class="row"></div>
		...
		<section class="contato container-fluid">
			<div class="container">
				...
				<article class="col-md-4 contato__single contato__single--right">
					...
					<p>ouvidoria@marcosinacio.adv.br</p>
				</article> <!-- contato__single -->
				...
				<article class="mapa-site__endereco col-md-3 col-xs-12">
					...
					<div class="footer__redes">
						...
						<div class="footer__redes--links">
							<a href="https://www.facebook.com/MarcosInacioAdvocacia/" target="_blank"><img src="<?php echo get_theme_file_uri('/assets/images/social/fb.png') ?>" alt="Facebook" title="Facebook"></a>
							<a href="https://www.instagram.com/marcosinacio.adv/" target="_blank"><img src="<?php echo get_theme_file_uri('/assets/images/social/insta.png') ?>" alt="Instagram" title="Instagram"></a>
							<a href="https://www.linkedin.com/in/marcosinacioadv/" target="_blank"><img src="<?php echo get_theme_file_uri('/assets/images/social/in.png') ?>" alt="LinkedIn" title="LinkedIn"></a>
							<a href="https://twitter.com/MIAdvocacia" target="_blank"><img src="<?php echo get_theme_file_uri('/assets/images/social/twitter.png') ?>" alt="Twitter" title="Twitter"></a>
							<a href="https://www.youtube.com/channel/UCFHJ2QsROA3wPhuiALuvMTA" target="_blank"><img src="<?php echo get_theme_file_uri('/assets/images/social/youtube.png') ?>" alt="Youtube" title="Youtube"></a>
						</div>
					</div>
				</article>
			</div><!--  container -->
